...
import { FormulaEditor } from '@/components/blockly/FormulaEditor';
    ...
    return (
        <main className="min-h-screen bg-slate-50 px-6 py-8">
            <header className="mb-6 flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-semibold">Редактор формулы</h1>
                    <p className="text-sm text-slate-500">
                        ID формулы: <code className="text-xs">{id}</code>
                    </p>
                </div>
